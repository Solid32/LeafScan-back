...
class Leaf_Builder(tfds.core.GeneratorBasedBuilder):
  """The PlantVillage dataset of healthy and unhealthy leaves."""
  ...
  def _split_generators(self, dl_manager):
    ...
    path = dl_manager.download_and_extract(_URL, extract_dir="/home/chinzi/code/Solid32/LeafScan-back/raw_data")
    return [
...
tfds.builder("plant_village_dataset", builder_cls=Leaf_Builder)
